/* Generated by Cython 0.19.2 on Tue Mar 11 00:51:43 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__entropy_maximization__weight_vector
#define __PYX_HAVE_API__entropy_maximization__weight_vector
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* "entropy_maximization/weight_vector.pxd":8
 * 
 * 
...
/* "entropy_maximization/weight_vector.pyx":20
 * 
 * 
 * cdef class WeightVector_s(object):             # <<<<<<<<<<<<<<
...
#define __Pyx_MODULE_NAME "entropy_maximization.weight_vector"
int __pyx_module_is_main_entropy_maximization__weight_vector = 0;

/* Implementation of 'entropy_maximization.weight_vector' */
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static int __pyx_pf_20entropy_maximization_13weight_vector_14WeightVector_s___cinit__(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *__pyx_v_self, PyArrayObject *__pyx_v_w); /* proto */
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags); /* proto */
static void __pyx_pf_5numpy_7ndarray_2__releasebuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info); /* proto */
static PyObject *__pyx_tp_new_20entropy_maximization_13weight_vector_WeightVector_s(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* Python wrapper */
static int __pyx_pw_20entropy_maximization_13weight_vector_14WeightVector_s_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_20entropy_maximization_13weight_vector_14WeightVector_s_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("entropy_maximization.weight_vector.WeightVector_s.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_20entropy_maximization_13weight_vector_14WeightVector_s___cinit__(((struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *)__pyx_v_self), __pyx_v_w);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = -1;
  __pyx_L0:;
...
/* "entropy_maximization/weight_vector.pyx":25
 * 
 * 
...
static int __pyx_pf_20entropy_maximization_13weight_vector_14WeightVector_s___cinit__(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *__pyx_v_self, PyArrayObject *__pyx_v_w) {
  float *__pyx_v_wdata;
  ...
  __pyx_pybuffernd_w.rcbuffer = &__pyx_pybuffer_w;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_w.rcbuffer->pybuffer, (PyObject*)__pyx_v_w, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "entropy_maximization/weight_vector.pyx":26
 * 
 *     def __cinit__(self, np.ndarray[float, ndim=2, mode='c'] w):
 *         cdef float *wdata = <float *>w.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":28
 *         cdef float *wdata = <float *>w.data
 * 
 *         if w.shape[0] > INT_MAX:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "entropy_maximization/weight_vector.pyx":30
 *         if w.shape[0] > INT_MAX:
 *             raise ValueError("More than %d features not supported; got %d."
 *                              % (INT_MAX, w.shape[0]))             # <<<<<<<<<<<<<<
 *         self.w = w
 ...
 */
    __pyx_t_2 = PyInt_FromLong(INT_MAX); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyInt_to_py_Py_intptr_t((__pyx_v_w->dimensions[0])); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __pyx_t_2 = 0;
    __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Remainder(((PyObject *)__pyx_kp_s_1), ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __pyx_t_3 = 0;
    __pyx_t_3 = PyObject_Call(__pyx_builtin_ValueError, ((PyObject *)__pyx_t_4), NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
  ...
  /* "entropy_maximization/weight_vector.pyx":31
 *             raise ValueError("More than %d features not supported; got %d."
 *                              % (INT_MAX, w.shape[0]))
 *         self.w = w             # <<<<<<<<<<<<<<
 *         self.w_data_ptr = wdata
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":32
 *                              % (INT_MAX, w.shape[0]))
 *         self.w = w
 *         self.w_data_ptr = wdata             # <<<<<<<<<<<<<<
 *         self.wscale = 1.0
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":33
 *         self.w = w
 *         self.w_data_ptr = wdata
 *         self.wscale = 1.0             # <<<<<<<<<<<<<<
 *         self.n_features = w.shape[0]
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":34
 *         self.w_data_ptr = wdata
 *         self.wscale = 1.0
 *         self.n_features = w.shape[0]             # <<<<<<<<<<<<<<
 *         self.n_classes = w.shape[1]
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":35
 *         self.wscale = 1.0
 *         self.n_features = w.shape[0]
 *         self.n_classes = w.shape[1]             # <<<<<<<<<<<<<<
 *         self.stride_row = <int> w.strides[0] / w.itemsize
 ...
 */
  __pyx_v_self->n_classes = (__pyx_v_w->dimensions[1]);

  /* "entropy_maximization/weight_vector.pyx":36
 *         self.n_features = w.shape[0]
 *         self.n_classes = w.shape[1]
 *         self.stride_row = <int> w.strides[0] / w.itemsize             # <<<<<<<<<<<<<<
 *         self.stride_col = <int> w.strides[1] / w.itemsize
 * 
 */
  __pyx_t_3 = PyInt_FromLong(((int)(__pyx_v_w->strides[0]))); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_w), __pyx_n_s__itemsize); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyNumber_Divide(__pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __pyx_v_self->stride_row = __pyx_t_5;

  /* "entropy_maximization/weight_vector.pyx":37
 *         self.n_classes = w.shape[1]
 *         self.stride_row = <int> w.strides[0] / w.itemsize
 *         self.stride_col = <int> w.strides[1] / w.itemsize             # <<<<<<<<<<<<<<
 * 
 *     # y <- alpha x * W + beta *y
 */
  __pyx_t_2 = PyInt_FromLong(((int)(__pyx_v_w->strides[1]))); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_w), __pyx_n_s__itemsize); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = __Pyx_PyNumber_Divide(__pyx_t_2, __pyx_t_4); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_self->stride_col = __pyx_t_5;
...
/* "entropy_maximization/weight_vector.pyx":40
 * 
 *     # y <- alpha x * W + beta *y
...
static void __pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_gemv(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *__pyx_v_self, float __pyx_v_alpha, float *__pyx_v_x_data_ptr, int *__pyx_v_x_ind_ptr, int __pyx_v_xnnz, float __pyx_v_beta, float *__pyx_v_y) {
  int __pyx_v_j;
  int __pyx_v_idx;
  float __pyx_v_val;
  ...
  int __pyx_v_stride_col;
  int __pyx_v_stride_row;
  int __pyx_t_1;
  float __pyx_t_2;
  float *__pyx_t_3;
  int __pyx_t_4;

  /* "entropy_maximization/weight_vector.pyx":45
 *         cdef int idx
 *         cdef float val
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":48
 *         cdef int offset
 * 
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":49
 * 
 *         cdef float wscale = self.wscale
 *         cdef float* w_data_ptr = self.w_data_ptr             # <<<<<<<<<<<<<<
 *         cdef int stride_col = self.stride_col
 ...
 */
  __pyx_t_3 = __pyx_v_self->w_data_ptr;
  __pyx_v_w_data_ptr = __pyx_t_3;

  /* "entropy_maximization/weight_vector.pyx":50
 *         cdef float wscale = self.wscale
 *         cdef float* w_data_ptr = self.w_data_ptr
 *         cdef int stride_col = self.stride_col             # <<<<<<<<<<<<<<
 *         cdef int stride_row = self.stride_row
 * 
 */
  __pyx_t_1 = __pyx_v_self->stride_col;
  __pyx_v_stride_col = __pyx_t_1;

  /* "entropy_maximization/weight_vector.pyx":51
 *         cdef float* w_data_ptr = self.w_data_ptr
 *         cdef int stride_col = self.stride_col
 *         cdef int stride_row = self.stride_row             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __pyx_v_self->stride_row;
  __pyx_v_stride_row = __pyx_t_1;

  /* "entropy_maximization/weight_vector.pyx":53
 *         cdef int stride_row = self.stride_row
 * 
 *         sscal(<int>(self.n_classes), beta, y, 1)             # <<<<<<<<<<<<<<
 * 
 *         for j in range(xnnz):
 */
  cblas_sscal(((int)__pyx_v_self->n_classes), __pyx_v_beta, __pyx_v_y, 1);

  /* "entropy_maximization/weight_vector.pyx":55
 *         sscal(<int>(self.n_classes), beta, y, 1)
 * 
 *         for j in range(xnnz):             # <<<<<<<<<<<<<<
 *             idx = x_ind_ptr[j]
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_1; __pyx_t_4+=1) {
    ...
    /* "entropy_maximization/weight_vector.pyx":56
 * 
 *         for j in range(xnnz):
 *             idx = x_ind_ptr[j]             # <<<<<<<<<<<<<<
 *             val = x_data_ptr[j]
 ...
 */
    ...
    /* "entropy_maximization/weight_vector.pyx":57
 *         for j in range(xnnz):
 *             idx = x_ind_ptr[j]
 *             val = x_data_ptr[j]             # <<<<<<<<<<<<<<
 *             offset = idx * stride_row
 ...
 */
    ...
    /* "entropy_maximization/weight_vector.pyx":58
 *             idx = x_ind_ptr[j]
 *             val = x_data_ptr[j]
 *             offset = idx * stride_row             # <<<<<<<<<<<<<<
 *             saxpy(n_classes,alpha * val * wscale, w_data_ptr + offset, stride_col, y, 1 )
 * 
 */
    __pyx_v_offset = (__pyx_v_idx * __pyx_v_stride_row);

    /* "entropy_maximization/weight_vector.pyx":59
 *             val = x_data_ptr[j]
 *             offset = idx * stride_row
 *             saxpy(n_classes,alpha * val * wscale, w_data_ptr + offset, stride_col, y, 1 )             # <<<<<<<<<<<<<<
 * 
 *     # W <- alpha * x * y ^T + W
 */
    cblas_saxpy(__pyx_v_n_classes, ((__pyx_v_alpha * __pyx_v_val) * __pyx_v_wscale), (__pyx_v_w_data_ptr + __pyx_v_offset), __pyx_v_stride_col, __pyx_v_y, 1);
  }

}

/* "entropy_maximization/weight_vector.pyx":62
 * 
 *     # W <- alpha * x * y ^T + W
...
static void __pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_ger(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *__pyx_v_self, float __pyx_v_alpha, float *__pyx_v_x_data_ptr, int *__pyx_v_x_ind_ptr, int __pyx_v_xnnz, float *__pyx_v_y) {
  ...
  /* "entropy_maximization/weight_vector.pyx":67
 *         cdef int idx
 *         cdef float val
 *         cdef int n_classes = self.n_classes             # <<<<<<<<<<<<<<
 *         cdef int offset
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":70
 *         cdef int offset
 * 
 *         cdef float wscale = self.wscale             # <<<<<<<<<<<<<<
 *         cdef float* w_data_ptr = self.w_data_ptr
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":71
 * 
 *         cdef float wscale = self.wscale
 *         cdef float* w_data_ptr = self.w_data_ptr             # <<<<<<<<<<<<<<
 *         cdef int stride_col = self.stride_col
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":72
 *         cdef float wscale = self.wscale
 *         cdef float* w_data_ptr = self.w_data_ptr
 *         cdef int stride_col = self.stride_col             # <<<<<<<<<<<<<<
 *         cdef int stride_row = self.stride_row
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":73
 *         cdef float* w_data_ptr = self.w_data_ptr
 *         cdef int stride_col = self.stride_col
 *         cdef int stride_row = self.stride_row             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":75
 *         cdef int stride_row = self.stride_row
 * 
 *         for j in range(xnnz):             # <<<<<<<<<<<<<<
 *             idx = x_ind_ptr[j]
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_1; __pyx_t_4+=1) {
    ...
    /* "entropy_maximization/weight_vector.pyx":76
 * 
 *         for j in range(xnnz):
 *             idx = x_ind_ptr[j]             # <<<<<<<<<<<<<<
 *             val = x_data_ptr[j]
 ...
 */
    ...
    /* "entropy_maximization/weight_vector.pyx":77
 *         for j in range(xnnz):
 *             idx = x_ind_ptr[j]
 *             val = x_data_ptr[j]             # <<<<<<<<<<<<<<
 *             offset = idx * stride_row
 ...
 */
    ...
    /* "entropy_maximization/weight_vector.pyx":78
 *             idx = x_ind_ptr[j]
 *             val = x_data_ptr[j]
 *             offset = idx * stride_row             # <<<<<<<<<<<<<<
 *             saxpy(n_classes,alpha * val/wscale, y,1, w_data_ptr + offset, stride_col )
 ...
 */
    ...
    /* "entropy_maximization/weight_vector.pyx":79
 *             val = x_data_ptr[j]
 *             offset = idx * stride_row
 *             saxpy(n_classes,alpha * val/wscale, y,1, w_data_ptr + offset, stride_col )             # <<<<<<<<<<<<<<
 * 
 ...
 */
    cblas_saxpy(__pyx_v_n_classes, ((__pyx_v_alpha * __pyx_v_val) / __pyx_v_wscale), __pyx_v_y, 1, (__pyx_v_w_data_ptr + __pyx_v_offset), __pyx_v_stride_col);
  }

}

/* "entropy_maximization/weight_vector.pyx":81
 *             saxpy(n_classes,alpha * val/wscale, y,1, w_data_ptr + offset, stride_col )
 * 
 *     cdef void scale(self, float c) nogil:             # <<<<<<<<<<<<<<
...
static void __pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_scale(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *__pyx_v_self, float __pyx_v_c) {
  int __pyx_t_1;

  /* "entropy_maximization/weight_vector.pyx":86
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":87
 *         small we call ``reset_swcale``."""
 *         self.wscale *= c
 *         if self.wscale < 1e-9:             # <<<<<<<<<<<<<<
 *             self.reset_wscale()
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "entropy_maximization/weight_vector.pyx":88
 *         self.wscale *= c
 *         if self.wscale < 1e-9:
 *             self.reset_wscale()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ((struct __pyx_vtabstruct_20entropy_maximization_13weight_vector_WeightVector_s *)__pyx_v_self->__pyx_vtab)->reset_wscale(__pyx_v_self);
    goto __pyx_L3;
  }
  __pyx_L3:;
...
/* "entropy_maximization/weight_vector.pyx":90
 *             self.reset_wscale()
 * 
 *     cdef void reset_wscale(self) nogil:             # <<<<<<<<<<<<<<
...
static void __pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_reset_wscale(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *__pyx_v_self) {
  float *__pyx_v_w_data_ptr;
  float *__pyx_t_1;

  /* "entropy_maximization/weight_vector.pyx":92
 *     cdef void reset_wscale(self) nogil:
 *         """Scales each coef of ``w`` by ``wscale`` and resets it to 1. """
 *         cdef float* w_data_ptr = self.w_data_ptr             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":93
 *         """Scales each coef of ``w`` by ``wscale`` and resets it to 1. """
 *         cdef float* w_data_ptr = self.w_data_ptr
 *         sscal(<int>(self.n_classes * self.n_features), self.wscale, w_data_ptr, 1)             # <<<<<<<<<<<<<<
 *         self.wscale = 1.0
 * 
 */
  cblas_sscal(((int)(__pyx_v_self->n_classes * __pyx_v_self->n_features)), __pyx_v_self->wscale, __pyx_v_w_data_ptr, 1);

  /* "entropy_maximization/weight_vector.pyx":94
 *         cdef float* w_data_ptr = self.w_data_ptr
 *         sscal(<int>(self.n_classes * self.n_features), self.wscale, w_data_ptr, 1)
 *         self.wscale = 1.0             # <<<<<<<<<<<<<<
 * 
...
/* "entropy_maximization/weight_vector.pyx":96
 *         self.wscale = 1.0
 * 
 *     cdef void copy(self, float *d) nogil:             # <<<<<<<<<<<<<<
 *         cdef float* w_data_ptr = self.w_data_ptr
...
static void __pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_copy(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *__pyx_v_self, float *__pyx_v_d) {
  float *__pyx_v_w_data_ptr;
  float *__pyx_t_1;

  /* "entropy_maximization/weight_vector.pyx":97
 * 
 *     cdef void copy(self, float *d) nogil:
 *         cdef float* w_data_ptr = self.w_data_ptr             # <<<<<<<<<<<<<<
 *         scopy(<int>(self.n_classes * self.n_features), w_data_ptr,1, d, 1)
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":98
 *     cdef void copy(self, float *d) nogil:
 *         cdef float* w_data_ptr = self.w_data_ptr
 *         scopy(<int>(self.n_classes * self.n_features), w_data_ptr,1, d, 1)             # <<<<<<<<<<<<<<
 *         sscal(<int>(self.n_classes * self.n_features), self.wscale, d, 1)
 * 
 */
  cblas_scopy(((int)(__pyx_v_self->n_classes * __pyx_v_self->n_features)), __pyx_v_w_data_ptr, 1, __pyx_v_d, 1);

  /* "entropy_maximization/weight_vector.pyx":99
 *         cdef float* w_data_ptr = self.w_data_ptr
 *         scopy(<int>(self.n_classes * self.n_features), w_data_ptr,1, d, 1)
 *         sscal(<int>(self.n_classes * self.n_features), self.wscale, d, 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  cblas_sscal(((int)(__pyx_v_self->n_classes * __pyx_v_self->n_features)), __pyx_v_self->wscale, __pyx_v_d, 1);

}

/* "entropy_maximization/weight_vector.pyx":101
 *         sscal(<int>(self.n_classes * self.n_features), self.wscale, d, 1)
 * 
 *     cdef void copy_in(self, float *d) nogil:             # <<<<<<<<<<<<<<
 *         cdef float* w_data_ptr = self.w_data_ptr
...
static void __pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_copy_in(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *__pyx_v_self, float *__pyx_v_d) {
  float *__pyx_v_w_data_ptr;
  float *__pyx_t_1;

  /* "entropy_maximization/weight_vector.pyx":102
 * 
 *     cdef void copy_in(self, float *d) nogil:
 *         cdef float* w_data_ptr = self.w_data_ptr             # <<<<<<<<<<<<<<
 *         scopy(<int>(self.n_features * self.n_classes), d, 1 ,w_data_ptr,1)
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":103
 *     cdef void copy_in(self, float *d) nogil:
 *         cdef float* w_data_ptr = self.w_data_ptr
 *         scopy(<int>(self.n_features * self.n_classes), d, 1 ,w_data_ptr,1)             # <<<<<<<<<<<<<<
 *         self.wscale = 1.0
 */
  cblas_scopy(((int)(__pyx_v_self->n_features * __pyx_v_self->n_classes)), __pyx_v_d, 1, __pyx_v_w_data_ptr, 1);

  /* "entropy_maximization/weight_vector.pyx":104
 *         cdef float* w_data_ptr = self.w_data_ptr
 *         scopy(<int>(self.n_features * self.n_classes), d, 1 ,w_data_ptr,1)
 *         self.wscale = 1.0             # <<<<<<<<<<<<<<
 */
...
static struct __pyx_vtabstruct_20entropy_maximization_13weight_vector_WeightVector_s __pyx_vtable_20entropy_maximization_13weight_vector_WeightVector_s;

static PyObject *__pyx_tp_new_20entropy_maximization_13weight_vector_WeightVector_s(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *p;
  PyObject *o;
  o = (*t->tp_alloc)(t, 0);
  if (unlikely(!o)) return 0;
  p = ((struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *)o);
  p->__pyx_vtab = __pyx_vtabptr_20entropy_maximization_13weight_vector_WeightVector_s;
  p->w = ((PyArrayObject *)Py_None); Py_INCREF(Py_None);
  if (unlikely(__pyx_pw_20entropy_maximization_13weight_vector_14WeightVector_s_1__cinit__(o, a, k) < 0)) {
    Py_DECREF(o); o = 0;
  }
  return o;
}

static void __pyx_tp_dealloc_20entropy_maximization_13weight_vector_WeightVector_s(PyObject *o) {
  struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *p = (struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *)o;
  PyObject_GC_UnTrack(o);
  Py_CLEAR(p->w);
  (*Py_TYPE(o)->tp_free)(o);
}

static int __pyx_tp_traverse_20entropy_maximization_13weight_vector_WeightVector_s(PyObject *o, visitproc v, void *a) {
  int e;
  struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *p = (struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *)o;
  if (p->w) {
...
static int __pyx_tp_clear_20entropy_maximization_13weight_vector_WeightVector_s(PyObject *o) {
  struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *p = (struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *)o;
  PyObject* tmp;
  tmp = ((PyObject*)p->w);
  p->w = ((PyArrayObject *)Py_None); Py_INCREF(Py_None);
...
static PyMethodDef __pyx_methods_20entropy_maximization_13weight_vector_WeightVector_s[] = {
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_20entropy_maximization_13weight_vector_WeightVector_s = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("entropy_maximization.weight_vector.WeightVector_s"), /*tp_name*/
  sizeof(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_20entropy_maximization_13weight_vector_WeightVector_s, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  __Pyx_DOCSTR("Dense matrix represented by a scalar and a numpy array.\n    "), /*tp_doc*/
  __pyx_tp_traverse_20entropy_maximization_13weight_vector_WeightVector_s, /*tp_traverse*/
  __pyx_tp_clear_20entropy_maximization_13weight_vector_WeightVector_s, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_20entropy_maximization_13weight_vector_WeightVector_s, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_20entropy_maximization_13weight_vector_WeightVector_s, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "entropy_maximization.weight_vector")) {
      if (unlikely(PyDict_SetItemString(modules, "entropy_maximization.weight_vector", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  ...
  #endif
  if (__pyx_module_is_main_entropy_maximization__weight_vector) {
  ...
  /*--- Type init code ---*/
  __pyx_vtabptr_20entropy_maximization_13weight_vector_WeightVector_s = &__pyx_vtable_20entropy_maximization_13weight_vector_WeightVector_s;
  __pyx_vtable_20entropy_maximization_13weight_vector_WeightVector_s.gemv = (void (*)(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *, float, float *, int *, int, float, float *))__pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_gemv;
  __pyx_vtable_20entropy_maximization_13weight_vector_WeightVector_s.ger = (void (*)(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *, float, float *, int *, int, float *))__pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_ger;
  __pyx_vtable_20entropy_maximization_13weight_vector_WeightVector_s.scale = (void (*)(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *, float))__pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_scale;
  __pyx_vtable_20entropy_maximization_13weight_vector_WeightVector_s.reset_wscale = (void (*)(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *))__pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_reset_wscale;
  __pyx_vtable_20entropy_maximization_13weight_vector_WeightVector_s.copy = (void (*)(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *, float *))__pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_copy;
  __pyx_vtable_20entropy_maximization_13weight_vector_WeightVector_s.copy_in = (void (*)(struct __pyx_obj_20entropy_maximization_13weight_vector_WeightVector_s *, float *))__pyx_f_20entropy_maximization_13weight_vector_14WeightVector_s_copy_in;
  if (PyType_Ready(&__pyx_type_20entropy_maximization_13weight_vector_WeightVector_s) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetVtable(__pyx_type_20entropy_maximization_13weight_vector_WeightVector_s.tp_dict, __pyx_vtabptr_20entropy_maximization_13weight_vector_WeightVector_s) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "WeightVector_s", (PyObject *)&__pyx_type_20entropy_maximization_13weight_vector_WeightVector_s) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_20entropy_maximization_13weight_vector_WeightVector_s = &__pyx_type_20entropy_maximization_13weight_vector_WeightVector_s;
  /*--- Type import code ---*/
  ...
  /* "entropy_maximization/weight_vector.pyx":8
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":17
 * 
 * 
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "entropy_maximization/weight_vector.pyx":1
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init entropy_maximization.weight_vector", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init entropy_maximization.weight_vector");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
